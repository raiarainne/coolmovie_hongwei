...
class AppWidget {
  ...
  static Widget yellowChair() {
    return ClipRRect(
      ...
      child: Container(
        ...
        child: SvgPicture.asset("assets/images/chair-dark.svg"),
      ),
    );
  }
    ...
    Widget star(bool fill) {
      return Container(
        child: Icon(
          Icons.star,
          size: 18,
          color: fill ? ColorConstants.kPrimaryColor : Colors.grey,
        ),
      );
    }
  ...
  static Widget starRating_leftalign(int rating) {
    Widget star(bool fill) {
      return Container(
        child: Icon(
          Icons.star,
